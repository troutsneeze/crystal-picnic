...
// these have to do with drawing text using full-size high res fonts
extern float font_scale;
extern ALLEGRO_TRANSFORM korean_transform;
...
bool set_clipping_rectangle(int x, int y, int width, int height, bool scale=true);
