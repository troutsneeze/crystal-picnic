...
end_interface:
	if ((cart_battle || dynamic_cast<Runner_Loop *>(this)) && !battle_transition_done) {
		...
		if (p > 1) {
			...
			al_draw_filled_rectangle(0, 0, al_get_display_width(engine->get_display()), al_get_display_height(engine->get_display()), al_map_rgba_f(0, 0, 0, p));
		}
	}
